...
// Array containing article data (author_id, title, category, published, summary, full_text, img_url),
// published is added automatically because of DEFAULT CURRENT TIMESTAMP in the table creation query,
// article_id is added automatically because of AUTO_INCREMENT
$articles_array = array(
	array(1, "Ian McKellen Explains Why He Passed on Playing Albus Dumbledore", "Entertainment", "Ian McKellen is widely known as Gandalf in The Lord of the Rings series, but he could have played another wise, magical mentor – Albus Dumbledore of Harry Potter fame.",
	...
	array(2, "Steven Gerrard officially announces retirement from football", "Sports", "Former Liverpool and England captain Steven Gerrard has officially announced his retirement from professional football.",
	...
	array(3, "President Trump To Move White House to Las Vegas", "Politics", "Donald Trump has made plans to officially move the White House from Washington, D.C. to Las Vegas, where he owns property and says that the taxes are \"much more manageable.\"",
	...
	array(4, "Man Killed After Mistakenly Thinking Red Bull Energy Drink Would Give Him Literal Wings", "Entertainment", "A 23-year-old man, Jacob Andrews, was killed yesterday after he jumped out of the window of his 6th floor apartment in Carlson,
