      ...
      if (isset($_FILES["new_img"]["name"])) {
         ...
         if (!empty($name)) {
            ...
            if($extension != "jpg" && $extension != "png" && $extension != "jpeg" && $extension != "gif" ) {
               ...
               $msg = "<p class='error'>Sorry, only JPG, JPEG, PNG & GIF files are allowed.</p>";
            }
            // File is ok
            else{
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="cold-md-12 info_text">
               ...
               <p class="feedback_msg"><?=$msg?></p>
            </div> <!-- End of info_text -->
         </div> <!-- End of row -->

         <!-- <form class="" action="profile.php" method="post">
            <input type="submit" name="new_article" value="Upload">
         </form> -->
         ...
         <!-- <form class="" action="profile.php" method="post">
            <input type="submit" name="edit_details" value="Edit">
         </form> -->
